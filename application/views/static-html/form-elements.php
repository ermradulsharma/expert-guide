                        ...
                        <div class="col-md-12">
                            <div class="panel">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        <label for="cname">Req (required, at least 2 characters)</label>
                                          <input id="myInput" name="name" minlength="2" type="text" class="form-control" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon border-0"><i class="icon-user"></i></div>
