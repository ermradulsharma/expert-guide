...
<div class="wrapper-page">
    ...
    <div class="page-title">
        <h1><i class="icon-list"></i>Play Single</h1>
    </div>
                                ...
                                <tbody>
                                    ...
                                    foreach ($requestlist as $value) : ?>
                                        <tr>
                                            ...
                                            <td class="action-buttons"><a onclick="return confirm('Are you sure to delete this data?')" href="single_delet?id=<?php echo $value->id; ?>"><i class="icon-close"></i></a></td>
                                        </tr>
                                    <?PHP $sr++;
                                    endforeach; ?>
                                </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header modal-primary">
                ...
                <h4 class="modal-title" id="modal-label">Single Game</h4>
            </div>
...
<script>
    $("#addcategory").on("click", function(event) {
        ...
        $.ajax({
            url: "<?php echo base_url(); ?>user/save_single",
            type: "POST",
            dataType: 'json',
            data: {
                //'id': $('#id').val(),
