...
<div class="wrapper-page">
    <div class="page-title">
        <h1><i class="icon-list"></i> Big Description</h1>
    </div>
                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-body panel-heading-wrapper">
                            <h5 class="pull-left">Big Description</h5>

                            <button type="button" data-id="1" name="submit" class="btn btn-custom pull-right userbutton"> Edit Big Description </button>
                        </div>
                ...
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content">
                        <div class="modal-header modal-primary">
                            ...
                            <h4 class="modal-title" id="modal-label">Big Description</h4>
                        </div>
...
<script>
    $("#btnSubmit").on("click", function(event) {
        ...
        $.ajax({
            url: "<?php echo base_url();?>admin/save_b_description",
            type: "POST",
            dataType: 'json',
            data: {
                'id': $('#id').val(),
