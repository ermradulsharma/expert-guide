            ...
            <div class="form-wrapper">
                ...
                <div class="form">
                 ...
                 <!--    <div class="form-group">
                    ...
                    <input type="submit" class="btn btn-primary btn-fullwidth" id="loginBtn" data-id="dashboard" value="Submit"> &nbsp <a href="<?php echo base_url(); ?>registration" type="button" class="btn btn-primary">Register</a>
                </div>
                <?php echo form_close(); ?>
