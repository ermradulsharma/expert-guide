...
<div class="wrapper-page">
    ...
    <div class="page-title">
        <h1><i class="icon-plus"></i> Add Staff</h1>
    </div>
                ...
                <div class="col-md-8">
                    <div class="content_wrapper">
                        ...
                        <div class="table_banner clearfix">
                            <h5 class="table_banner_title">Add Staff</h5>
                        </div>

                        <form role="form" action="saveStaff"  id="UserValueUpdate" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                            <div class="p2415">
                                <div class="form-group clearfix">
                                    <label for="inputMaxLength" class="col-md-3">Staff Name</label>
                                    <div class="col-md-9">
