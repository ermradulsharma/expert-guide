...
<div class="wrapper-page">
    ...
    <div class="page-title">
        <h1><i class="icon-list"></i>Notifications</h1>
    </div>
                ...
                <div class="col-md-12">
                    <div class="content_wrapper">
                        ...
                        <div class="table_banner clearfix">
                            <h5 class="table_banner_title">Notifications</h5>
                        </div>
                        ...
                        <div class="table_body text-left">
                            <table id="example" class="table table-condensed responsive table_custom" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php $sr = 1; foreach($notifications as $value): ?>
                                    <tr>
                                        <td>
                                            <?php echo $sr; ?>
                                        </td>
                                        <td>
                                            ...
                                            <a href="<?php echo base_url(); ?>admin/View_profile? =<?php echo $value->id ?>">
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header modal-primary">
                    ...
                    <h4 class="modal-title" id="modal-label">Update Notifications</h4>
                </div>

                <form role="form" action="updatenotification"  id="BlogValueUpdate" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                    <div class="modal-body">

                        <div class="form-group clearfix">
                            <div class="col-md-9 col-md-offset-3">
                                <div class="file_prev" style="display: inline-block;"></div>
                                <label for="user_image" class="custom-file-upload">Image</label>
                            </div>
                            <div class="col-md-9 col-md-offset-3">
                        ...
                        <div class="form-group clearfix">
                            <label for="inputMaxLength" class="col-md-3">Description</label>
                            <div class="col-md-9">
                                <input type="text" name="text" id="text" class="form-control" id="inputMaxLength" value='' placeholder="Description " required >
                            </div>
                        </div>   
                        <div class="form-group clearfix">
...
$.ajax({
    url: '<?php echo base_url(); ?>admin/notificationbyid?id=' + iid,
    method: 'GET',
    data: '',
    dataType: 'json',
}).done(function (response) {
    var theForm = $('#BlogValueUpdate');
    theForm.find('[name="id"]').val(response.notificationvalue.id).end()
    .find('[name="text"]').val(response.notificationvalue.text).end()
       .find('[name="status"]').val(response.notificationvalue.status).end()
    var imgSrc = '<?php echo base_url(); ?>' + 'assets/img/notifications/' + response.notificationvalue.user_image;
