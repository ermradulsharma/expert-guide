<!doctype html><?php $settingsvalue = $this->Admin_model->getSettingsValue(); ?>
                            ...
                            <li class="dropdown">
                                ...
                                <div class="dropdown-menu topbar-dropdown-wrapper" role="menu">
                                    <ul class="dropdown-user-inner">
                                        ...
                                        <li class="divider"></li> 
                                        <li data-id="users" class="main"><a href="<?php echo base_url();?>staff/View_profile?U=<?php echo base64_encode($this->session->userdata('user_login_id')); ?>"><i class="icon-user mr10"></i> Profile</a></li>
                ...
                <nav class="sidebar-nav">
                    <ul>
                        <li data-id="dashboard" id="dashboard" class="main">
                            <a class="" href="<?php echo current_url(); ?>" aria-expanded="false">
                                <i class="icon-grid"></i>
                                <span class="">
                                    Dashboard
                                </span>
                        ...
                        <!-- <li data-id="market" id="market" class="main">
                            <a class="" href="<?php echo base_url(); ?>staff/markets" aria-expanded="false">
                                <i class="icon-user"></i>
                                <span class="">
                                   Markets
                                </span>
                         ...
                         <li data-id="resultss" id="resultss" class="main">
                            <a class="" href="<?php echo base_url(); ?>staff/results" aria-expanded="false">
                                <i class="icon-user"></i>
                                <span class="">
                                 Results
                                </span>
